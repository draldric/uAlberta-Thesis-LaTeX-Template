...
\chapter{JabRef: Managing Bibliographies Efficiently}\label{ch:jabref}
	...
	\section{Getting Started with JabRef}
		...
		\subsection{Creating a New Bibliography}
			...
			\begin{figure}[htbp]
				\centering
				\insertimage[width=0.7\linewidth]{JabRef_Main_Window.png}
		...
		\subsection{Adding References}
			...
			\subsubsection{Web Search}
				...
				\begin{figure}[htbp]
					\centering
					\insertimage[width=0.35\linewidth]{JabRef_Web_Search.png}
				...
				\begin{figure}[htbp]
					\centering
					\insertimage[width=0.7\linewidth]{JabRef_Example_Web_Search.png}
			...
			\subsubsection{Manual Entry}
				...
				\begin{enumerate}
					\item Click `Library' \(\rightarrow\) `New entry' or use the shortcut `Ctrl + N' and this will show the following window.%
						\begin{center}%
							\insertimage[width=0.5\linewidth]{JabRef_New_Entry.png}
						\end{center}%
	...
	\section{Exploring Advanced Features of JabRef}
		...
		In this section, we will explore some of the advanced features that enhance the efficiency and effectiveness of JabRef as a reference manager.
		...
		\subsection{Managing PDFs and File Links}
			...
			These annotations can be found by selecting the entry, and selecting the `File annotations' tab.
				...
				\begin{figure}[htbp]
					\centering
					\insertimage[width=0.7\linewidth]{JabRef_File_Annotations.png}
