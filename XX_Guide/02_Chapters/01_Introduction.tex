...
\chapter{Introduction}\label{ch:introduction}
	\section{Background}
		As a graduate student from the \University, I am familiar with the challenging task of writing a thesis that adheres to the \Faculty\ Minimum Thesis Formatting Requirements.
		Using a traditional word processor to create a long document filled with equations and figures can be frustrating due to frequent crashes, file c\(\theta\)r\(^r\)\textsubscript{$\mu$}pt\textit{1}n, unpredictable \textbf{for}\textit{mat}\texttt{ting} changes, and the inability to output a document in the required PDF/A format for submission to \Fac.
		...
		\LaTeX\ attempts to separate the formatting from the content of the writing.
		Thus allowing students and researchers to focus on the content and, typically, have the formatting of their documents managed automatically by templates or class and style files.
	...
	\section{Objectives}
		...
		\begin{enumerate}
			\item To remind you of the current\footnote{Always double check the information presented in this guide against the information provided by the \Faculty.} requirement for writing a thesis at the \University.
			\item To assist students and researchers in mastering the nuances of \LaTeX\ document preparation.
			\item To provide a comprehensive guide on writing a thesis using \LaTeX\ and this template.
			\item To showcase best practices and examples for structuring and formatting a thesis in \LaTeX\ with this template.
		\end{enumerate}
