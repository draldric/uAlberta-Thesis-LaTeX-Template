...
%TODO: Fix overflowing text
		...
		\subsection{Dedication or Quotations}\label{quote}\label{dedication}
			...
			In the template provided, you may fill in the appropriate Quote and Dedication fields (\cmd{thesisquote and \cmd{dedication}, respectively}) in the document \path{01_Prefatory/Quotes_Dedications.tex}.
