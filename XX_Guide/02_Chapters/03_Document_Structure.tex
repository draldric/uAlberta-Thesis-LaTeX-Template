...
%TODO: Fix overflowing text
		...
		\subsection{Dedication or Quotations}\label{quote}\label{dedication}
			...
			Or you can just comment out the command \cmd{setquotetext} or \cmd{setdedicationtext} if you are unsure of whether you want to include one now or not and would just like to temporarily disable one or both of them.
