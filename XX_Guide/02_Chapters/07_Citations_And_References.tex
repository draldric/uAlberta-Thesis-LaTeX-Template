...
\chapter{Citations, References, and Cross-References}\label{ch:citref}
	...
	\section{Cross-References}
		...
		Some of these are provided by the \pkg{hyperref}\footfullcite{hyperref} and \pkg{cleveref}\footfullcite{cleveref} packages.
		...
		\lstinputlisting{./99_Inclusions/Code/cleveref-setup}
