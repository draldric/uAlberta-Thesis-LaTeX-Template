...
\noindent\lstinline[basicstyle=\ttfamily]|\begin{lstlisting}[language=Python]|\\[-0.7em]
\lstinline[basicstyle=\ttfamily]|	# Your code here|\\[-0.7em]
\lstinline[basicstyle=\ttfamily]|	print("Hello, world!")|\\[-0.7em]
\lstinline[basicstyle=\ttfamily]|\end{lstlisting}|
...
\lstset{
	...
	breaklines=true
			...
			\insertcode[caption=This is a caption for the inserted code,style=MatlabStyle]{matlabCode.m}

			\insertcode[caption=This is a caption for the inserted code,style=CStyle]{cCode.cpp}
