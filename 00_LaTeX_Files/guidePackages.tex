...
%% NEW COMMANDS
	...
	\newcommand{\danger}[1]{%
		\noindent
		\begin{tabularx}{\linewidth}{@{}lX@{}}
			\color{black}\colorbox{red}{\faFlag\ \textsc{\textbf{DANGER}}} & {\textbf{\MakeUppercase{#1}}}
		\end{tabularx}}
	...
	\newcommand{\caution}[1]{%
		\noindent
		\begin{tabularx}{\linewidth}{@{}lX@{}}
			\color{black}\colorbox{yellow}{\faExclamationCircle\ \textsc{\textbf{CAUTION}}} & {#1}
		\end{tabularx}}

	\newcommand{\notice}[1]{%
		\noindent
		\begin{tabularx}{\linewidth}{@{}lX@{}}
			\color{white}\colorbox{black}{\faInfoCircle\ \textsc{\textbf{\textsl{NOTICE}}}} & {#1}
		\end{tabularx}}

	\newcommand{\alert}[1]{%
		\noindent
		\begin{tabularx}{\linewidth}{@{}lX@{}}
			\faBell\ \textbf{Alert} & {#1}
		\end{tabularx}}

	\newcommand{\note}[1]{%
		\noindent
		\begin{tabularx}{\linewidth}{@{}lX@{}}
			\textbf{\faStickyNoteO\ \textsl{Note: }} & {\textit{#1}}
		\end{tabularx}}
	...
	\newcommand{\qna}[2]{%
		...
		\noindent
		\begin{tabularx}{\linewidth}{@{}lX@{}}
			\-\hspace{4ex}{\color{orange}{\faCheckCircle}} & \textit{#2}
		\end{tabularx}}
	...
	\newcommand{\important}[1]{%
		\noindent
		\begin{tabularx}{\linewidth}{@{}lX@{}}
			\textcolor{purple}{\faStar} & \textcolor{purple}{#1}
		\end{tabularx}}
