...
\end{figure}
		...
		While this section provided a few examples on how to make some figures and sub figures, I would strongly recommend checking out the examples in "SEE APPENDINX EXAMPE FIGURES".
		This will provide the code and examples for how to create more intricate subfigures.
...
\end{table}
		...
		In these examples, the longtable environment is used for tables that span multiple pages. 
	...
	\section{Conclusion}
		...
		From basic insertion of figures to advanced table formatting using packages like tabularx, booktabs, and others, you now have a solid foundation to include tables and figures in your thesis.
