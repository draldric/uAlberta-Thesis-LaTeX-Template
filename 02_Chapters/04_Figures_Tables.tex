...
\end{table}
	...
	\section{Conclusion}
		...
		For this \Cref{ch:plots} provides in-depth workings of the \pkg{pgfplots} package and how to generate consistent and professional looking plots and graphs.