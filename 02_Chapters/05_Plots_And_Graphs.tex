\chapter{Plots, Charts, \& Graphs}\label{ch:plots}
	...
	\section{Line Plots}
		...
		\begin{lstlisting}[float=h,caption=,label=lst:line-plot,style=LaTeXStyle,basicstyle=\small\ttfamily,]
\begin{figure}[H]
	\centering
	\begin{tikzpicture}
		\begin{axis}[
...
\end{figure}
		...
		\begin{lstlisting}[float=h,caption=,label=lst:line-plot-2,style=LaTeXStyle,basicstyle=\small\ttfamily,]
\addplot coordinates {
	(0,16)
	(1,9)
	(2,4)
	...
	\section{Customizing Plots}
		...
		\subsection{Adding a Legend}
			...
			\begin{lstlisting}[float=h,caption=,label=lst:legend-plot,style=LaTeXStyle,basicstyle=\small\ttfamily,]
\begin{figure}[H]
	\centering
	\begin{tikzpicture}
		\begin{axis}[
