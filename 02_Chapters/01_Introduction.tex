\chapter{Introduction}\label{ch:Introduction}
	...
	\section{Scope and Limitations}
		Although there are existing templates for writing a thesis in \LaTeX\ for the \UofA\ (see \Cref{tab:OtherTemplates} for a list of available templates), none seem to provide all the necessary information for creating an outstanding thesis.
