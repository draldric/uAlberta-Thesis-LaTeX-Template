\chapter{Introduction}\label{ch:Introduction}
	...
	\section{Using this Guide}
		...
		\commenting{This is an example of a comment. These will primarily be used to indication a fourth-wall comment, \textit{i.e.}, a comment that is beyond the typical narration that is found in this document.}
		...
		\opt{Option}
		\oopt{Optional-Option}
		\mopt{Mandatory-Option}

		\env{Environment}

		\benv{Begin-Environment}
		\eenv{End-Environment}
